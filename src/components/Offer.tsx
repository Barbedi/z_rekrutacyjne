...
const Offer = () => {
  return (
    <section
      id="oferta"
      className="relative grid grid-cols-1 gap-5 pt-10 pb-13 lg:grid-cols-12 lg:gap-16 lg:pt-30 lg:pb-40 bg-[#F5F0EC] items-center"
    >
      <div className="flex flex-col col-start-3 col-span-7 items-start gap-20">
        <div className="flex flex-col gap-8 items-start">
          <div className="flex flex-col gap-4 max-w-lg">
            ...
            <h2 className="lg:text-5xl text-2xl text-black font-montserrat font-medium leading-[115%] tracking-[-3%]">
              Działamy{" "}
          ...
          <p className="lg:text-base text-sm text-black font-inter font-normal leading-[150%] lg:max-w-xl max-w-xs tracking-[-1%]">
      ...
      <div className="col-span-12 col-start-1 flex w-full flex-col lg:flex-row items-start lg:items-center gap-5 lg:gap-16 px-7 lg:px-22">
        <a
          id="projects"
          className=" cursor-pointer flex group col-auto flex-col px-10 py-12 bg-white hover:bg-[#1B5B31]/15 gap-3 rounded-[28px] hover:-translate-y-1.5 hover:shadow-xl shadow-[#1B5B31]/30 transition-all duration-300 ease-out "
        >
          <div className="flex flex-col  gap-8 items-start">
            <FontAwesomeIcon
