    ...
    >
      <div className=" py-7 lg:py-20 px-7 lg:px-64 col-span-4 lg:col-span-12 flex flex-col gap-8 lg:gap-30 ">
        <div>
          ...
          <div className="border-t lg:border-[#F5F0EC] border-[#F5F0EC]/30 my-5 lg:my-15.5"></div>
          <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center items-start w-full">
            ...
            <div className="flex flex-col lg:flex-row gap-2 lg:gap-12 lg:items-center text-start">
        ...
        <div className="border-t border-[#F5F0EC]/30 my-0.5 lg:hidden"></div>
